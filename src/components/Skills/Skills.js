...
const Skills = () => {
    const BorderLinearProgress = styled(LinearProgress)(({ theme }) => ({
        ...
        [`& .${linearProgressClasses.bar}`]: {
            borderRadius: 5,
            backgroundColor: theme.palette.mode === 'light' ? '#667388' : '#308fe8',
        },
    }));
    return (
        <div className='skillContainer'>
            ...
            <div className='skillsListContainer'>
                <ul className='skillsList'>
                    ...
                    <li><span className='li-title'>Django</span> <BorderLinearProgress variant="determinate" value={80} /></li>
                ...
                <ul className='skillsList'>
                    ...
                    <li><span className='li-title'>Material UI</span> <BorderLinearProgress variant="determinate" value={70} /></li>
