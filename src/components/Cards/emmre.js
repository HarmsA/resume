            ...
            <Card sx={{ maxWidth: 400, height: 500 }}>
                ...
                <CardContent>
                    ...
                    <Typography className='cardBody' variant="body2" color="text.secondary">
                        I built this site once in Django years ago, then once as a single page site in ReactJs as a demo. The live site was not build by me but I assisted in the building of it. The owner of emmre is my brother who hired a social media marketer who knew a little programming to build the site in wordpress. Many times that employee struggled to add features or specific styling to the site, this is where I assisted. Eventhough I dont work in wordpress I was able to figure out how to add every feature and styling they wanted to complete the site.
                    </Typography>
                </CardContent>
